        ...
        <div class="col-lg-8">
            ...
            <div class="text-center mb-4">
                ...
                <p class="text-secondary">
                    Cadastre um filme, série ou livro.
                </p>
                    ...
                    <form method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <select
                                ...
                                <option value="Filme" @selected(old('tipo') == 'Filme')>
                                    Filme
                                </option>

                                <option value="Serie" @selected(old('tipo') == 'Serie')>
                                    Série
                                </option>

                                <option value="Livro" @selected(old('tipo') == 'Livro')>
                                    Livro
                                </option>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select
                                    ...
                                    @foreach($autores as $autor)
                                        ...
                                        <option
                                            value="{{ $autor->id }}"
                                            @selected(old('autor_id') == $autor->id)>
